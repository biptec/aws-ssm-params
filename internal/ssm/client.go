...
type Client interface {
	...
	GetMany(context.Context, []string) (map[string]Parameter, map[string]error)
	DescribeMany(context.Context, []string) map[string]Metadata
	ListParameterMetadata(context.Context) ([]Metadata, error)
	ListParameterMetadataWithFilters(context.Context, []ParameterFilter) ([]Metadata, error)
	PutParameterWithOptions(context.Context, string, string, ParameterType, PutParameterOptions) error
...
type regionAPI interface {
	DescribeRegions(context.Context, *AWSClient) ([]awsRegion, error)
}
